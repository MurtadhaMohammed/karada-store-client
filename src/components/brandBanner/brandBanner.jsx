...
const brands = [
  {
    id: 46,
    name: "DOOGEE",
    img: "image-_0C_tQ.png",
    created_at: "2024-11-22T22:28:07.068Z",
    store_id: 1,
    active: true,
    priority: 0,
  },
  {
    id: 45,
    name: "Poco",
    img: "image-3S2xnj.png",
    created_at: "2024-11-22T21:55:24.531Z",
    store_id: 1,
    active: true,
    priority: 0,
  },

  {
    id: 40,
    name: "Xiaomi",
    img: "image-PnSkLk.png",
    created_at: "2024-11-12T14:42:38.767Z",
    store_id: 1,
    active: true,
    priority: 0,
  },
  {
    id: 39,
    name: "Black Shark",
    img: "image-ibTvZn.png",
    created_at: "2024-11-12T09:17:44.670Z",
    store_id: 1,
    active: true,
    priority: 0,
  },
  {
    id: 89,
    name: "coolmoon",
    img: "image-kR005V.png",
    created_at: "2025-01-20T19:59:12.744Z",
    store_id: 1,
    active: true,
    priority: 0,
  },
  ...
  },
  {
    id: 13,
    name: "INFINX ",
    img: "image-i6Dez3.jpg",
    created_at: "2024-10-23T11:48:09.811Z",
    store_id: 1,
    active: true,
    priority: 0,
  },
  {
    id: 90,
    name: "Asus TUF",
    img: "image-9dUK5b.png",
    created_at: "2025-01-23T17:25:02.601Z",
    store_id: 1,
    active: true,
    priority: 0,
  },
  {
    id: 96,
    name: "Segotep",
    img: "image-gjw-sv.jpg",
    created_at: "2025-01-29T23:00:52.473Z",
    store_id: 1,
    active: true,
    priority: 0,
  },
...
const BrandBanner = ({ title, list = [], bannerId }) => {
  return (
    <div className=" mt-[8px] mb-[8px] pt-[24px] pb-[24px] bg-[#eee]">
      <Container>
        <div className="grid md:grid-cols-5 grid-cols-5  gap-3  justify-center">
          {brands?.map((brand) => (
            <div className="aspect-1 overflow-hidden relative rounded-lg bg-white">
          ...
          <div className="aspect-1 overflow-hidden shadow-brand-custom relative rounded-full bg-[#7c3aed] flex items-center justify-center active:opacity-40 transition-all">
            <LuMoreVertical className="md:text-[60px] text-[30px] text-[#fff]" />
          </div>
        </div>
      </Container>
    </div>
