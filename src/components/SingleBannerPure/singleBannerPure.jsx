    ...
    return (
        <div className="md:mt-[24px] md:mb-[24px] mt-[16px] mb-[16px]">
          ...
          <Link href={banner?.link ? banner.link : `/products/banner/${banner?.id}`}>
            <div className="w-[100%] md:aspect-[3.5] aspect-3 relative bg-white rounded-[16px] overflow-hidden pb-[20px] inline-block shadow-md active:opacity-50 transition-all">
              <div className="">
                <Image
